        ...
        {selectedLog && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 w-full max-w-2xl bg-white dark:bg-[#1C1C1E] shadow-2xl z-50 flex flex-col border-l border-apple-gray-200 dark:border-white/10"
            >
              <div className="flex items-center justify-between p-6 border-b border-apple-gray-200 dark:border-white/10 bg-white/80 dark:bg-[#1C1C1E]/80 backdrop-blur-xl">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => setSelectedLog(null)}
                    className="p-2 text-apple-gray-400 dark:text-gray-500 hover:text-apple-gray-600 dark:hover:text-gray-200 hover:bg-apple-gray-100 dark:hover:bg-white/10 rounded-full transition-colors"
                  >
