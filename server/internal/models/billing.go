...
type Plan struct {
	...
	PriceMonth   decimal.Decimal `gorm:"type:numeric(20,8);not null" json:"price_month"` // Monthly price in USD
...
type Transaction struct {
	...
	Amount      decimal.Decimal `gorm:"type:numeric(20,8);not null" json:"amount"`
	Currency    string          `gorm:"default:'USD'" json:"currency"`
	Balance     decimal.Decimal `gorm:"type:numeric(20,8)" json:"balance"` // Balance AFTER this transaction
	Description string          `json:"description"`
...
type Budget struct {
	...
	MonthlyLimitUSD  decimal.Decimal `gorm:"type:numeric(20,8);not null" json:"monthly_limit_usd"`
